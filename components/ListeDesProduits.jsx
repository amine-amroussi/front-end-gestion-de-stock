...
"use client";
import { Trash, Edit, ChevronRight, ChevronLeft, Printer, Search } from "lucide-react";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (response.status === 200) {
        await fetchAllProducts(pagination.currentPage, pagination.pageSize, filters);
    ...
    <div className="space-y-6">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {products?.map((product) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">{product.designation}</td>
                <td className="px-6 py-4 whitespace-nowrap">{product.genre}</td>
                <td className="px-6 py-4 whitespace-nowrap text-center">{product.stock || 0}</td>
                <td className="px-6 py-4 whitespace-nowrap text-center">{product.uniteInStock || 0}</td>
                <td className="px-6 py-4 whitespace-nowrap">{product.priceUnite || 0}</td>
                <td className="px-6 py-4 whitespace-nowrap text-center">{product.capacityByBox || 0}</td>
      ...
      {pagination.totalItems > 0 && (
        <p className="text-center mt-2 text-sm text-gray-500">
          Affichage de {products.length} sur {pagination.totalItems} produits (Page{" "}
